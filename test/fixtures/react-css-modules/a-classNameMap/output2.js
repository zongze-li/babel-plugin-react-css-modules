...
<div className="Homepage__home-page">
  ...
  <div className="home-page-header1" />
  <div {...rest} className={(0, _getClassName2.default)("home-page-header", _styleModuleImportMap, {
  ...
  <canvas id='pressCanvas' className={(0, _getClassName2.default)('press-canvas', _styleModuleImportMap, {
    "autoResolveMultipleImports": true,
    "handleMissingStyleName": "warn",
    "include": {
      "0": "a-classNameMap"
